...
def read_frames_av(
    video_path, num_frames, sample="rand", fix_start=None, max_num_frames=-1
):
...
VIDEO_READER_FUNCS = {"av": read_frames_av, "decord": read_frames_decord}
