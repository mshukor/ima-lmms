...
from timesformer.models.vit_utils import (IMAGENET_DEFAULT_MEAN,
                                          IMAGENET_DEFAULT_STD, DropPath,
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.model.default_cfg = default_cfgs[
            "timesformer_vit_base_patch" + str(patch_size) + "_224"
        ]
                    ...
                    if H > W:
                        ...
                        x = [
                            torchvision.transforms.functional.resize(
                                x[:, :, i, :, :], (self.img_size, self.img_size)
                            ).unsqueeze(2)
