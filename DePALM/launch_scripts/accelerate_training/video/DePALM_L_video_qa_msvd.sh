...
#SBATCH --job-name=DePALM_L_video_qa_msvd_l0_1_qsformerl10_llamav2vicuna_xclipl
#SBATCH --nodes=1
#SBATCH --partition=gpu_p2
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=8
#SBATCH --mail-type=END,FAIL
#SBATCH --output=logs/slurm/DePALM_L_video_qa_msvd_l0_1_qsformerl10_llamav2vicuna_xclipl.out
...
NUM_GPUS=8
data_dir=$SCRATCH/data/MSVD

config=./configs/video/DePALM_L_video_qa_msvd.yaml
output_dir=$WORK/logs/DePalm/DePALM_L_video_qa_msvd_llamav2vicuna_timesformer
