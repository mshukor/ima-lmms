...
#SBATCH --job-name=DePALM_L_video_qa_msrvtqa_l0_1_qsformerl10_llamav2vicuna_timesformer
#SBATCH --nodes=1
#SBATCH --partition=gpu_p2
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=8
#SBATCH --mail-type=END,FAIL
#SBATCH --output=logs/slurm/DePALM_L_video_qa_msrvtqa_l0_1_qsformerl10_llamav2vicuna_timesformer_test2.out
...
config=./configs/video/DePALM_L_video_qa_msrvtt.yaml
output_dir=$WORK/logs/DePalm/DePALM_L_video_qa_msrvtqa_llamav2vicuna_timesformer
