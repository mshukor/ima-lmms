...
#SBATCH --job-name=DePALM_gqa_qformerl10_llamav2vicuna_clipl
#SBATCH --nodes=1
#SBATCH --partition=gpu_p2
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=8
#SBATCH --mail-type=END,FAIL
#SBATCH --output=logs/slurm/DePALM_gqa_qformerl10_llamav2vicuna_clipl.out
...
config=./configs/image/gqa/DePALM_L_gqa.yaml
output_dir=$WORK/logs/DePalm/DePALM_gqa_llamav2vicuna_vitl
